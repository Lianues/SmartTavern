...
""",
    input_schema={
        ...
        "properties": {
            "data_type": {
                "type": "string",
                "description": "数据类型：preset, character, worldbook, persona, regex_rule, llm_config",
                "enum": ["preset", "character", "worldbook", "persona", "regex_rule", "llm_config"]
            },
            "file_content_base64": {
                "type": "string",
...
""",
    input_schema={
        ...
        "properties": {
            ...
            "data_type": {
                "type": ["string", "null"],
                "description": "数据类型（可选，自动从路径检测）：preset, character, worldbook, persona, regex_rule, llm_config",
                "enum": ["preset", "character", "worldbook", "persona", "regex_rule", "llm_config", None]
            },
            "embed_image_base64": {
                "type": ["string", "null"],
