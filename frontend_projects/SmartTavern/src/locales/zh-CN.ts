...
const zhCN = {
  ...
  detail: {
    ...
    persona: {
      ...
      basicInfo: '基本信息',
      userName: '用户名称',
      userNamePlaceholder: '输入用户名称',
      userDesc: '用户描述',
      userDescPlaceholder: '输入用户描述，可以包含用户的偏好、背景、对话风格等...',
      currentValue: '当前',
      notSet: '(未设置)',
      charCount: '字符数',
  ...
  appearance: {
    ...
    placeholder: '此为占位页面，用于配置应用主页相关选项。',
    unknownTab: '未知页签',
    ...
    theme: {
      title: '主题管理',
      desc: '导入外部主题包（.json/.sttheme.json），或重置为内置风格。',
      importTitle: '导入主题包',
  ...
  home: {
    ...
    gallery: {
      title: '画廊',
      placeholder: '占位界面：未来这里展示截图与插画素材，支持筛选与全屏预览。',
    },
    // 读取存档
    loadGame: {
      title: '读取存档',
    ...
    newChat: {
      ...
      llmConfigLabel: 'AI配置（必选）',
      llmConfigPlaceholder: '请选择AI配置',
      presetLabel: '预设（必选）',
      ...
      requiredError: '请先选择：AI配置、预设、角色卡、用户信息（必选）',
