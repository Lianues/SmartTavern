...
const jaJP = {
  ...
  detail: {
    ...
    persona: {
      ...
      userDesc: 'ユーザー説明',
      userDescPlaceholder: 'ユーザーの説明を入力（好み、背景、会話スタイルなど）...',
      currentValue: '現在',
      notSet: '（未設定）',
      charCount: '文字数',
  ...
  appearance: {
    ...
    tabs: {
      home: 'ホーム',
      threaded: 'スレッドチャット',
      sandbox: 'フルスクリーンサンドボックス',
      backgrounds: '背景画像',
      theme: 'テーマ',
    },
    placeholder: 'これはホームページオプションを設定するためのプレースホルダページです。',
    unknownTab: '不明なタブ',
    ...
    theme: {
      title: 'テーマ管理',
      desc: '外部テーマパッケージ（.json/.sttheme.json）をインポートするか、組み込みスタイルにリセットします。',
  ...
  home: {
    ...
    gallery: {
      title: 'ギャラリー',
      placeholder: 'プレースホルダ：将来的にはスクリーンショットとイラストが表示され、フィルタリングとフルスクリーンプレビューが可能になります。',
    },
    // ゲームをロード
    loadGame: {
      title: 'ゲームをロード',
    ...
    newChat: {
      ...
      llmConfigLabel: 'AI設定（必須）',
      llmConfigPlaceholder: 'AI設定を選択',
      ...
      requiredError: '選択してください：AI設定、プリセット、キャラクター、ペルソナ（必須）',
